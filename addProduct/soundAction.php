...
// initializing variables
  ...
  $user_check_query = "SELECT * FROM sound WHERE productname='$productname' OR title='$title' LIMIT 1";
...
// Allow certain file formats 
  ...
  // Finally, register user if there are no errors in the form
	if (count($errors) == 0 && in_array($fileType, $allowTypes)) {
		...
		$query = "INSERT INTO sound (fimg, bimg, productname, title, price, stock, dis, sip, war,mrp) 
