 <head>
        ...
        <title>Add Hair Dryer / Hair Straighteners</title>
  ...
  form {
    ...
    <body>
	 <?php include "header1.php" ?>
      <form action="dryerAction.php" method="post" enctype="multipart/form-data">
       <h1>Add Hair Dryer / Hair Straighteners / Trimmer</h1>
