 <head>
        ...
        <title>Add bluetooth and Speaker</title>
...
@media screen and (min-width: 480px) {
  ...
  form {
	...
	<?php include "header1.php" ?>
      <form action="blueAction.php.php" method="post" enctype="multipart/form-data">
      
       <h1>Add Bluetooth and Portable Wirelss speakers</h1>
