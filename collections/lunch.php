...
<html class="no-js" lang="en">
   ...
   <body class="warehouse--v1 features--animate-zoom template-collection " data-instant-intensity="viewport">
					...
					<div class="page__sub-header">
						<nav aria-label="Breadcrumb" class="breadcrumb">
							<ol class="breadcrumb__list">
							   ...
							   <li class="breadcrumb__item"><span class="breadcrumb__link" aria-current="page">Kids Products</span></li>
							</ol>
						</nav>
					</div>
				</div>
	...
	<?php 
		...
		$result = $db->query("SELECT * FROM lunch ORDER BY id DESC LIMIT $start_from, $limit"); 
	?>
...
<div class="product-item__info">
    ...
    <?php
		...
		$result_db = mysqli_query($db,"SELECT COUNT(id) FROM lunch"); 
		...
		for ($i=1; $i<=$total_pages; $i++) {
					  $pagLink .= "<li class='page-item'><a class='page-link' href='lunch.php?page=".$i."'>".$i."</a></li>";	
		}
