...
<html class="no-js" lang="en">
   ...
   <body class="warehouse--v1 features--animate-zoom template-collection " data-instant-intensity="viewport">
					...
					<div class="page__sub-header">
						<nav aria-label="Breadcrumb" class="breadcrumb">
							<ol class="breadcrumb__list">
							   ...
							   <li class="breadcrumb__item"><span class="breadcrumb__link" aria-current="page">Burner/Induction</span></li>
							</ol>
						</nav>
					</div>
				</div>
	...
	<?php 
		...
		$result = $db->query("SELECT * FROM product where type= 'cooktop' ORDER BY id DESC LIMIT $start_from, $limit"); 
	?>
...
<div class="product-item__info">
    ...
    <?php
		...
		$result_db = mysqli_query($db,"SELECT COUNT(id) FROM product"); 
