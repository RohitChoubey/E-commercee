...
<html class="no-js" lang="en">
      ...
      <script type="application/ld+json">
         ...
         "itemListElement": [{
             ...
             "item": "https://warehouse-theme-metal.myshopify.com"
                 ...
                 "position": 2,
                 "name": "Earbuds",
                 "item": "https://warehouse-theme-metal.myshopify.com/collections/earbuds"
               }]
         }
      </script>
      <script>
   ...
   <body class="warehouse--v1 features--animate-zoom template-collection " data-instant-intensity="viewport">
					...
					<div class="page__sub-header">
						<nav aria-label="Breadcrumb" class="breadcrumb">
							<ol class="breadcrumb__list">
							   ...
							   <li class="breadcrumb__item"><span class="breadcrumb__link" aria-current="page">Jucier Mixer</span></li>
							</ol>
						</nav>
					</div>
				</div>
	 ...
	 <div class="collection__image-wrapper collection__image-wrapper--medium" style="background-image: url(../../cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_1x12ab8.jpg?v=1559427157)">
                    <div class="collection__image lazyload image--fade-in" data-bgset="//cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_600x.jpg?v=1559427157 600w, //cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_800x.jpg?v=1559427157 800w, //cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_1000x.jpg?v=1559427157 1000w, //cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_1200x.jpg?v=1559427157 1200w, //cdn.shopify.com/s/files/1/0065/3095/7363/collections/Earbuds-2_1500x.jpg?v=1559427157 1500w"></div>
                  </div>
	...
	<?php 
		...
		$result = $db->query("SELECT * FROM iron ORDER BY uploaded DESC"); 
	?>
...
<div class="product-list product-list--collection product-list--with-sidebar">
	...
	<?php if($result->num_rows > 0){ ?> 
		...
		?>
&ensp;&ensp;&ensp;&emsp;
   <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3'>&ensp;&ensp;&ensp;&ensp;&ensp;
      <a href="<?php printf('%s?id=%s', '../zoompro/rproduct.php',  $item['id']); ?>" class="product-item__image-wrapper ">
      ...
      <div class="product-item__info">
         <div class="product-item__info-inner">
            <a class="product-item__vendor link" href="<?php printf('%s?id=%s', '../zoompro/rproduct.php',  $item['id']); ?>">AKG</a>
            <a href="<?php printf('%s?id=%s', '../zoompro/rproduct.php',  $item['id']); ?>" class="product-item__title text--strong link">AKG N20U Premium In-Ear Headphones</a>&ensp;&ensp;&ensp;&ensp;&ensp;
            
            <div class="product-item__price-list price-list"><span class="price"><?php echo $item['id'] ?></span></div>
            ...
            <!--<span class="product-item__inventory inventory inventory--high">In stock, 141 units</span>-->
         </div>
         <!--<form method="post" action="https://warehouse-theme-metal.myshopify.com/cart/add" id="product_form_id_1916135178291_collection-template" accept-charset="UTF-8" class="product-item__action-list button-stack" enctype="multipart/form-data"><input type="hidden" name="form_type" value="product" /><input type="hidden" name="utf8" value="✓" /><input type="hidden" name="quantity" value="1">
            <input type="hidden" name="id" value="17549719011379"><a href="earbuds/products/akg-n20u-reference-class-in-ear-headphones-with-truly-universal-3-button-control.html" class="product-item__action-button button button--small button--primary">Choose options</a><button type="button" class="product-item__action-button button button--small button--ternary hidden-phone" data-action="open-modal" data-secondary-action="open-quick-view" aria-controls="modal-quick-view-collection-template" data-product-url="/products/akg-n20u-reference-class-in-ear-headphones-with-truly-universal-3-button-control">Quick view</button>
         </form>-->
      </div>
   </div>
   	  <?php }
