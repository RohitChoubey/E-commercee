...
<html class="no-js" lang="en">
   ...
   <body class="warehouse--v1 features--animate-zoom template-collection " data-instant-intensity="viewport">
	...
	<?php 
		...
		$result = $db->query("SELECT * FROM wmachine ORDER BY id DESC LIMIT $start_from, $limit"); 
	?>
...
div class="product-item__info">
		...
		<?php
			  ...
			  // TO delete the image 
				...
				$sql = "DELETE FROM wmachine WHERE id='".$id."'";
    ...
    <?php
		...
		$result_db = mysqli_query($db,"SELECT COUNT(id) FROM wmachine"); 
		...
		for ($i=1; $i<=$total_pages; $i++) {
					  $pagLink .= "<li class='page-item'><a class='page-link' href='earbuds.php?page=".$i."'>".$i."</a></li>";	
		}
