...
<html class="no-js" lang="en">
   ...
   <body class="warehouse--v1 features--animate-zoom template-collection " data-instant-intensity="viewport">
					...
					<div class="page__sub-header">
						<nav aria-label="Breadcrumb" class="breadcrumb">
							<ol class="breadcrumb__list">
							   ...
							   <li class="breadcrumb__item"><span class="breadcrumb__link" aria-current="page">Towel Sets</span></li>
							</ol>
						</nav>
					</div>
				</div>
	...
	<?php 
		...
		$result = $db->query("SELECT * FROM footwomen ORDER BY id DESC LIMIT $start_from, $limit"); 
	?>
...
&ensp;&ensp;&ensp;&emsp;
   <div class='col-sm-4 col-xs-6 col-md-3 col-lg-3' style="margin-left:60px;">&ensp;&ensp;&ensp;&ensp;&ensp;
        <a href="<?php printf('%s?id=%s', '../zoompro/fwproduct.php',  $item['id']); ?>" class="product-item__image-wrapper ">
...
div class="product-item__info">
         <div class="product-item__info-inner">
            <a class="product-item__vendor link" href="<?php printf('%s?id=%s', '../zoompro/fwproduct.php',  $item['id']); ?>"><?php echo $item['productname']; ?></a>
            <a href="<?php printf('%s?id=%s', '../zoompro/fwproduct.php',  $item['id']); ?>" class="product-item__title text--strong link"><?php echo $item['title']; ?></a>&ensp;&ensp;&ensp;&ensp;&ensp;
         ...
         <form method="post" action="" id="product_form_id_1916135178291_collection-template" accept-charset="UTF-8" class="product-item__action-list button-stack" enctype="multipart/form-data"><input type="hidden" name="form_type" value="product" /><input type="hidden" name="utf8" value="✓" /><input type="hidden" name="quantity" value="1">
			...
			<a href="<?php printf('%s?id=%s', '../zoompro/fwproduct.php',  $item['id']); ?>" class="product-item__action-button button button--small button--primary">Quick View</a><br/></form>
		...
		<?php
			  ...
			  // TO delete the image 
				...
				$sql = "DELETE FROM footwomen WHERE id='".$id."'";
				
				if(mysqli_query($db, $sql)){
		?>
					<script language="JavaScript">
						alert('Image Delete Sucessfully !');
						document.location='footwomen.php';
					</script>
				<?php
					} 
					else {
    ...
    <?php
		...
		$result_db = mysqli_query($db,"SELECT COUNT(id) FROM footwomen"); 
		...
		for ($i=1; $i<=$total_pages; $i++) {
					  $pagLink .= "<li class='page-item'><a class='page-link' href='footwomen.php?page=".$i."'>".$i."</a></li>";	
		}
