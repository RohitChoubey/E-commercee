...
require ('../functions.php');
    $id = $_GET['id'] ?? 1;
    foreach ($rproduct->getData() as $item) :
        if ($item['id'] == $id) :
?>
      ...
      <path d="M7.58801492 6.8808396L9.999992 9.292784l-.70716.707208-2.41193007-2.41199543C6.15725808 8.15916409 5.24343297 8.50004 4.25 8.50004c-2.347188 0-4.249968-1.902876-4.249968-4.2501C.000032 1.902704 1.902812.000128 4.25.000128c2.347176 0 4.249956 1.902576 4.249956 4.249812 0 .99341752-.34083418 1.90724151-.91194108 2.6308996zM4.25.999992C2.455064.999992.999992 2.454944.999992 4.24994c0 1.794984 1.455072 3.249936 3.250008 3.249936 1.794924 0 3.249996-1.454952 3.249996-3.249936C7.499996 2.454944 6.044924.999992 4.25.999992z" fill="currentColor" fill-rule="evenodd"></path>
            ...
            <div class="scroller__inner">
              <div class="product-gallery__thumbnail-list"><a href="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($item['fimg']); ?>" class="product-gallery__thumbnail is-nav-selected " data-media-id="2744985419827" ><div class="aspect-ratio" style="padding-bottom: 100.0%">
                      <img class="image--fade-in lazyload" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($item['fimg']); ?>" alt="Sony XBR-950G BRAVIA 4K HDR Ultra HD TV">
                    </div>
                      ...
                      <img class="image--fade-in lazyload" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($item['bimg']); ?>" alt="Sony XBR-950G BRAVIA 4K HDR Ultra HD TV">
                    </div>
                  </a></div>
            </div>
          </div></div>
...
<div class="product-meta"><h1 class="product-meta__title heading h1"><?php echo $item['title'] ?? "Unknown"; ?></h1><div class="product-meta__label-list"><span class="product-label product-label--on-sale" >Save <span>$800</span></span></div><div class="product-meta__reference"><a class="product-meta__vendor link link--accented" href="../../sony.html">Sony</a><span class="product-meta__sku">SKU: <span class="product-meta__sku-number">SON-695219-XBR-55</span>
...
<div class="product-form__variants"><div class="product-form__option" data-selector-type="block">
        ...
        <div class="product-form__info-item">
          ...
          <div class="product-form__info-content">
            ...
            <div class="product-form__info-content"><span class="product-form__inventory inventory inventory--high">In stock (72 units), ready to be shipped</span><span class="inventory-bar " data-stock-countdown-max="171.0">
      ...
      <div class="product-form__payment-container"><button type="submit" class="product-form__add-button button button--primary" data-action="add-to-cart">Add to cart</button><div data-samrat="payment-button" class="samrat-payment-button"><button class="samrat-payment-button__button samrat-payment-button__button--unbranded samrat-payment-button__button--hidden" disabled="disabled" aria-hidden="true"> </button><button class="samrat-payment-button__more-options samrat-payment-button__button--hidden" disabled="disabled" aria-hidden="true"> </button></div>
</div></form><div class="product-meta__share-buttons hidden-tablet-and-up">
...
<li>Once your product has shipped, it usually takes 2 to 3 business days.</li>
      ...
      <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="square" stroke-width="2">
        ...
        <path d="M9.00000011 16.5833337v1.8333333"></path>
                ...
                <div class="card__section"><p class="card__subtitle heading h6">Payment methods</p><div class="payment-list">
                    ...
                    <p class="payment-list__notice">Your payment information is processed securely. We do not store credit card details nor have access to your credit card information.</p><hr class="card__separator"><p class="card__subtitle heading h6">Security</p><img class="product__trust-badge" src="../../../../cdn.samrat.com/s/files/1/0065/3095/7363/files/security-badge_2x_c617fe08-f451-4659-b0eb-d891c81d1488_356x3c63.png?v=1573725578" srcset="//cdn.samrat.com/s/files/1/0065/3095/7363/files/security-badge_2x_c617fe08-f451-4659-b0eb-d891c81d1488_356x.png?v=1573725578 1x, //cdn.samrat.com/s/files/1/0065/3095/7363/files/security-badge_2x_c617fe08-f451-4659-b0eb-d891c81d1488_356x@2x.png?v=1573725578 2x" alt=""></div>
              </div>
            </div></div>
      </div>
