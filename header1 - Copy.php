                  ...
                  <div class="header__inner">
                              ...
                              <div class="mobile-menu__panel">
                                 <div class="mobile-menu__section">
                                    <ul class="mobile-menu__nav" data-type="menu">
                                       <li class="mobile-menu__nav-item"><a href="../collections/" class="mobile-menu__nav-link" data-type="menuitem">Offers</a></li>
									   ...
									   <?php 
										if(! isset($_SESSION['user_name'])){ ?>
											...
											<li class="mobile-menu__nav-item"><a href="../account/login.php" class="mobile-menu__nav-link" data-type="menuitem">Login</a></li>
										<?php 
										}
										else{
										?>
										<li><a href="../upload.php" class="scroll">Add Products</a></li>
                              ...
                              <div class="search-bar__top">
                                 ...
                                 <div class="search-bar__filter">
                                    ...
                                    <select id="search-product-type">
                                       ...
                                       <option value="iron">Stream/Dry Iron</option>
                                       <option value="sandwich">Sandwich Toasters</option>
                                       <option value="grillers">Grillers</option>
                                       ...
                                       <option value="trimer">Trimmers</option>
                                       <option value="hair">Hair Straighteners</option>
                                       <option value="tandoor">Electric Tandoor</option>
                                    </select>
                                 </div>
                     ...
                     <div class="header__action-list">
						...
						<a href="account/login.php">
                           ...
                           <div class="header__action-item-content">
                              <a href="account/login.php" class="header__action-item-link header__account-icon icon-state hidden-desk" aria-label="My account" aria-controls="account-popover" aria-expanded="false" data-action="toggle-popover" >
                                 <span class="icon-state__primary">
                              ...
                              <div class="container">
                                 <div class="mega-menu__inner mega-menu__inner--center mega-menu__inner--large">
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Juicers/Mixer/Grinder</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Stream / Dry Iron</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Sandwich Toaster</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Grillers</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">MicroWaves</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/audio-accessories.html" class="mega-menu__link link">Home Theatres</a>
                                          </li>
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Pizza Maker</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Sound Bar</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Tea & Coffe Maker</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Water Bottles</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Crockery</a>
                                          </li>
                                          <li class="mega-menu__item">
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          ...
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Led TV</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Air Conditioners</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Refrigerators</a>
                                          </li>
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Washing Machines</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Hair Dryer</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="./collections/" class="mega-menu__link link">Trimmers</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Hair Straighteners</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="../collections/" class="mega-menu__link link">Electric Tandoor</a>
                                          </li>
                                       </ul>
                                    </div>
                       ...
                       <!--  <li class="nav-bar__item"><a href="blogs/news.html" class="nav-bar__link link" data-type="menuitem">Blog</a></li> -->
						 ...
						 <?php 
										if(! isset($_SESSION['name'])){ ?>
											...
											<li class="nav-bar__item"><a href="account/login.php" class="nav-bar__link link" data-type="menuitem">Login</a></li>
										<?php 
										}
										else{
										?>
										<li class="nav-bar__item"><a href="../upload.php" class="nav-bar__link link" data-type="menuitem">Add Products</a></li>
