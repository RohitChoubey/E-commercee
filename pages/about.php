...
var meta = {"page":{"pageType":"page","resourceType":"page","resourceId":24740397107}};
    ...
    if (!isDuplicatedThankYouPageView()) {
      setCookieIfThankYouPage();
        ...
        window.ShopifyAnalytics.lib.page(
          null,
          {"pageType":"page","resourceType":"page","resourceId":24740397107}
        );
...
<script>
  ...
  <header class="page__header page__header--centered">
    <h1 class="page__title heading h1">About</h1>
  </header>
  <h3>Why choose New Samarat?</h3>
<div class="clearfix">
  <img class="img2" src="../cdn.samrat.com/s/files/1/0065/3095/7363/files/image-1_1024x10241f50.jpg?v=1559258195" alt="Pineapple" width="500" height="470">
 <p>Our mission statement is to provide the absolute best customer experience available in the all electronics industry without exception. We choose to only sell the best performing products in the world, learning them inside and out to ensure your experience with our organization and the products we supply is second to none. New Samrat is one of the Best electronics services  retailers in the India. All because of our passion for our products and our customers. We care like no one else.</p>
</div>
