    ...
    <div class="card__section card__section--tight">
      <div class="product-gallery product-gallery--with-thumbnails"><div class="product-gallery__carousel-wrapper">
          <div class="product-gallery__carousel product-gallery__carousel--zoomable" data-media-count="7" data-initial-media-id="2744985419827"><div class="product-gallery__carousel-item is-selected " tabindex="-1" data-media-id="2744985419827" data-media-type="image"  ><div class="product-gallery__size-limiter" style="max-width: 2571px"><div class="aspect-ratio" style="padding-bottom: 100.0%">
                        <img class="product-gallery__image lazyload image--fade-in" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['fimg']); ?>" data-widths="[400,500,600,700,800,900,1000,1100,1200]" data-sizes="auto" data-zoom="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['fimg']); ?>" alt="Sony XBR-950G BRAVIA 4K HDR Ultra HD TV">
                        ...
                        <img class="product-gallery__image lazyload image--fade-in" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['bimg']); ?>" data-widths="[400,500,600,700,800,900,1000,1100,1200]" data-sizes="auto" data-zoom="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['bimg']); ?>" alt="">
      ...
      <path d="M7.58801492 6.8808396L9.999992 9.292784l-.70716.707208-2.41193007-2.41199543C6.15725808 8.15916409 5.24343297 8.50004 4.25 8.50004c-2.347188 0-4.249968-1.902876-4.249968-4.2501C.000032 1.902704 1.902812.000128 4.25.000128c2.347176 0 4.249956 1.902576 4.249956 4.249812 0 .99341752-.34083418 1.90724151-.91194108 2.6308996zM4.25.999992C2.455064.999992.999992 2.454944.999992 4.24994c0 1.794984 1.455072 3.249936 3.250008 3.249936 1.794924 0 3.249996-1.454952 3.249996-3.249936C7.499996 2.454944 6.044924.999992 4.25.999992z" fill="currentColor" fill-rule="evenodd"></path>
            ...
            <div class="scroller__inner">
              <div class="product-gallery__thumbnail-list"><a href="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['fimg']); ?>" class="product-gallery__thumbnail is-nav-selected " data-media-id="2744985419827" ><div class="aspect-ratio" style="padding-bottom: 100.0%">
                      <img class="image--fade-in lazyload" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['fimg']); ?>" alt="">
                    </div>
                  </a><a href="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['bimg']); ?>" class="product-gallery__thumbnail  " data-media-id="2744985452595" ><div class="aspect-ratio" style="padding-bottom: 100.0%">
                      <img class="image--fade-in lazyload" data-src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['bimg']); ?>" alt="">
                    </div>
                  </a></div>
            </div>
          </div></div>
...
<div class="product-meta"><h1 class="product-meta__title heading h1"><?php echo $row['title'] ?? "Unknown"; ?></h1><div class="product-meta__label-list"><span class="product-label product-label--on-sale" >Save Rs. <span><?php echo $row['save'] ?? "Unknown"; ?></span></span></div>
...
<div class="product-form__variants"><div class="product-form__option" data-selector-type="block">
        ...
        <div class="product-form__info-item">
          ...
          <div class="product-form__info-content">
            <div class="price-list"><span class="price price--highlight">Rs. <?php echo $row['price'] ?? 0; ?></span>
                <span class="price price--compare">Rs. <?php echo $row['mrp'] ?? 0; ?></span></div>
            ...
            <div class="product-form__info-content"><span class="product-form__inventory inventory inventory--high"> <?php echo $row['stock'] ?? "out of stock"; ?></span><span class="inventory-bar " data-stock-countdown-max="171.0">
                    <span class="inventory-bar__progress" style="width: 100%"></span>
                  </span></div>
          </div><div class="product-form__info-item product-form__info-item--quantity">
              <label for="product-template-1916221128755-quantity" class="product-form__info-title text--strong">Warrenty: <?php echo $row['war'] ?? 0; ?></label>
