            ...
            <header class="header header--inline header--search-expanded" role="banner">
               <div class="container">
                  <div class="header__inner">
                              ...
                              <div class="mobile-menu__panel">
                                 <div class="mobile-menu__section">
                                    <ul class="mobile-menu__nav" data-type="menu">
                                       <li class="mobile-menu__nav-item"><a href="collections/new-arrivals.html" class="mobile-menu__nav-link" data-type="menuitem">Offers</a></li>
									   ...
									   <?php 
										if(! isset($_SESSION['email'])){ ?>
											<li class="mobile-menu__nav-item"><a href="pages/contact-us.php" class="mobile-menu__nav-link" data-type="menuitem">AboutUs</a></li>
											<li class="mobile-menu__nav-item"><a href="pages/contact-us.php" class="mobile-menu__nav-link" data-type="menuitem">Contact</a></li>
											<li class="mobile-menu__nav-item"><a href="login.php" class="mobile-menu__nav-link" data-type="menuitem">Login</a></li>
										<?php 
										}
										else{
										?>
										<li><a href="add/addProduct.php" class="scroll">Add Products</a></li>
                     ...
                     <h1 class="header__logo"><a href="index.php" class="header__logo-link"><img class="header__logo-image"
                        width="348"
                        height="64"
                        src=""                   
                        alt="New Smarat"></a></h1>
					 ...
					 <!-- Search Bar -->
                        ...
                        <form action="backend-search.php" method="get" role="search" class="search-bar">
                           <div class="search-bar__top-wrapper">
                              <div class="search-bar__top">
                                 <input type="hidden" name="type" value="product">
                                 <div class="search-bar__input-wrapper">
                                    <input class="search-bar__input" type="text" name="search" autocomplete="off" autocorrect="off" aria-label="Search..." placeholder="Search...">
                                 ...
                                 <div class="search-bar__filter">
                                    ...
                                    <select id="search-product-type">
                                       ...
                                       <option value="Jucier">Juicers/Mixer/Grinder</option>
                                       <option value="iron">Stream/Dry Iron / Garment Stremers</option>
                                       <option value="sandwich">Sandwich Toasters / Grillers</option>
                                      <option value="hbc">Hand Blender / Beaters / Choppers</option>
                                       <option value="micro">MicroWaves</option>
                                       <option value="home">Home Theatres</option>
									   <option value="pizza">Pizza Makers</option>
                                       <option value="sound">Sound Bars</option>
                                       <option value="coffe">Tea &  Coffe Makers</option>
                                       <option value="water">Water Bottles</option>
									   <option value="crockery">Crockery</option>
									   <option value="badsheets">Bad Sheets</option>
									   <option value="towel">Towel Sets</option>
                                       <option value="men">Footwear Men</option>
                                       <option value="women">Footwear Women</option>
                                       <option value="tv">TV</option>
                                       <option value="ac">Air Conditioners</option>
                                       <option value="machine">Washing Machines</option>
                                       <option value="hair">Hair / Dryer / Straighteners / Trimmers</option>
                                       <option value="et">Electric Tandoor</option>
									   <option value="suit">Suitcase / Laugage Bag</option>
									    <option value="hl">HandBags and Laptop Bags</option>
										<option value="lunch">Tiffen and Lunch Box</option>
										<option value="Kids">Kids</option>
										<option value="air">Air Purifires</option>
										<option value="fryers">Air Fryers</option>
                                    </select>
                                 </div>
                                 <button type="submit" name="submit" class="search-bar__submit" aria-label="Search">
                     ...
                     <div class="header__action-list">
						...
						<?php 
                           ...
                           <span class="header__action-item-title hidden-pocket hidden-lap">Log Out</span>
						</a>
						<?php }
						?>
                           <div class="header__action-item-content">
                              <a href="login.php" class="header__action-item-link header__account-icon icon-state hidden-desk" aria-label="My account" aria-controls="account-popover" aria-expanded="false" data-action="toggle-popover" >
                                 <span class="icon-state__primary">
                                 ...
                                 <div class="popover__panel-list">
                                    <div id="header-login-panel" class="popover__panel popover__panel--default is-selected">
                                       <div class="popover__inner">
                                          <form method="post" action="../loginAction.php?op=in" id="header_customer_login" accept-charset="UTF-8" name="login" class="form" enctype="multipart/form-data">
                                             ...
                                             <div class="form__input-wrapper form__input-wrapper--labelled">
                                                <input type="email" id="login-customer[email]" class="form__field form__field--text" name="user_name" required="required">
                                             ...
                                             <button type="submit" name="submit" class="form__submit button button--primary button--full">Login</button>
                                          </form>
                  ...
                  <div class="container">
                     <ul class="nav-bar__linklist list--unstyled" data-type="menu">
                        <li class="nav-bar__item">
                           <a href="collections.php" class="nav-bar__link link" data-type="menuitem" aria-expanded="false" aria-haspopup="true">
                              All Products
                              <svg class="icon icon--arrow-bottom" viewBox="0 0 12 8" role="presentation">
                                 <path stroke="currentColor" stroke-width="2" d="M10 2L6 6 2 2" fill="none" stroke-linecap="square"></path>
                              </svg>
                              ...
                              <div class="container">
                                 <div class="mega-menu__inner mega-menu__inner--center mega-menu__inner--large">
                                    <div class="mega-menu__column">
                                       <span class="mega-menu__title heading"></span>
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="collections/earbuds.php" class="mega-menu__link link">Juicers/Mixer/Grinder</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/iron.php" class="mega-menu__link link">Stream / Dry Iron</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/Sandwich.php" class="mega-menu__link link">Sandwich Toaster / Grillers</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/tandoor.php" class="mega-menu__link link">Oven / Otgs</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/tandoor.php" class="mega-menu__link link">MicroWaves / Electrical Tandoor</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/Sound.php" class="mega-menu__link link">Home Theatres / Sound Bars</a>
                                          </li>
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="collections/pizza.php" class="mega-menu__link link">Pizza Maker</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/coffeMaker.php" class="mega-menu__link link">Egg Boilers</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/coffeMaker.php" class="mega-menu__link link">Tea & Coffe Maker</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/water.php" class="mega-menu__link link">Water Bottles</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/crockery.php" class="mega-menu__link link">Crockery</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/" class="mega-menu__link link">Bed Sheets</a>
                                          </li>
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="collections/" class="mega-menu__link link">Footwear Men</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/" class="mega-menu__link link">Footwear Women</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/tv.php" class="mega-menu__link link">Led TV</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/ac.php" class="mega-menu__link link">Air Conditioners</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/refi.php" class="mega-menu__link link">Refrigerators</a>
                                          </li>
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          <li class="mega-menu__item">
                                             <a href="collections/wm.php" class="mega-menu__link link">Washing Machines</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/HairStaightener.php" class="mega-menu__link link">Hair Dryer</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/HairStaightener.php" class="mega-menu__link link">Trimmers</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/HairStaightener.php" class="mega-menu__link link">Hair Straighteners</a>
                                          </li>
                                          <li class="mega-menu__item">
                                             <a href="collections/tandoor.php" class="mega-menu__link link">Electric Tandoor</a>
                                          </li>
										   <li class="mega-menu__item">
                                             <a href="collections.php" class="mega-menu__link link">All Products</a>
                                          </li>
                                       </ul>
                                    </div>
                        ...
                        <li class="nav-bar__item"><a href="collections/" class="nav-bar__link link" data-type="menuitem">Offers</a></li>
                       ...
                       <!--  <li class="nav-bar__item"><a href="blogs/news.html" class="nav-bar__link link" data-type="menuitem">Blog</a></li> -->
						 ...
						 <?php 
										if(! isset($_SESSION['email'])){ ?>
										                        <li class="nav-bar__item"><a href="pages/about.php" class="nav-bar__link link" data-type="menuitem">AboutUs</a></li>
                        <li class="nav-bar__item"><a href="collections.php" class="nav-bar__link link" data-type="menuitem">All Collections</a></li>
											<li class="nav-bar__item"><a href="pages/brands.php" class="nav-bar__link link" data-type="menuitem">Brands</a></li>
											<li class="nav-bar__item"><a href="pages/contact-us.php" class="nav-bar__link link" data-type="menuitem">Contact</a></li>
											<li class="nav-bar__item"><a href="login.php" class="nav-bar__link link" data-type="menuitem">Login</a></li>
										<?php 
										}
										else{
										?>
										<li class="nav-bar__item"><a href="add/addProduct.php" class="nav-bar__link link" data-type="menuitem">Add Products</a></li>
										<!--<li class="nav-bar__item"><a href="#" class="nav-bar__link link">Hi, <?php /* echo $_SESSION["email"]; */ ?></a></li>-->
										<li class="nav-bar__item"><a href="account/logout.php	" class="nav-bar__link link">Log Out</a></li>
										<?php
											}
										?>
                     </ul>
