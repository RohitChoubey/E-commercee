                              ...
                              <div class="mobile-menu__panel">
                                 <div class="mobile-menu__section">
                                    <ul class="mobile-menu__nav" data-type="menu">
                                       <li class="mobile-menu__nav-item"><a href="../collections/sales.php" class="mobile-menu__nav-link" data-type="menuitem">Offers</a></li>
                                       <li class="mobile-menu__nav-item"><a href="../collections.php" class="mobile-menu__nav-link" data-type="menuitem">All Collections</a></li>
									   
									   <?php 
										if(! isset($_SESSION['user_name'])){ ?>
											<li class="mobile-menu__nav-item"><a href="../pages/about.php" class="mobile-menu__nav-link" data-type="menuitem">AboutUs</a></li>
               ...
               <div class="nav-bar__inner">
                  <div class="container">
                     <ul class="nav-bar__linklist list--unstyled" data-type="menu">
                                    ...
                                    <div class="mega-menu__column">
                                       ...
                                       <ul class="mega-menu__linklist">
                                          ...
                                          <li class="mega-menu__item">
										   ...
										   <li class="mega-menu__item">
                                             <a href="../collection.php" class="mega-menu__link link">All Products</a>
                                          </li>
                                       </ul>
                                    </div>
                        ...
                        <li class="nav-bar__item"><a href="../collections/sales.php" class="nav-bar__link link" data-type="menuitem">Offers</a></li>
                       ...
                       <!--  <li class="nav-bar__item"><a href="blogs/news.html" class="nav-bar__link link" data-type="menuitem">Blog</a></li> -->
						 ...
						 <?php 
										...
										<li class="nav-bar__item"><a href="#" class="nav-bar__link link">Hi, <?php echo $_SESSION["user_name"]; ?></a></li>
										<li class="nav-bar__item"><a href="../logout.php" class="nav-bar__link link">Log Out</a></li>
										<?php
											}
										?>
                     </ul>
